# Filename: Fep_Raw_Mac.py
# Author: Zheng Guo
# Date: 09-29-2020
# Purpose: Gathering fep ppo measure date from multiple rate reports, select star measure, and load data in the format that is ready to be loaded into the dashboard table. 
# Class list: None
...
# User Input:
# - First input: Various fep reports downloaded straight from fep direct website. Example: 072020FEPMD.xlsx
# - Second input: name.xlsx
#                      xlsx file containing the name of all the files, file name include .xlsx in the end
...
def data_format(t):
    ...
    df_excel['ReportMonth'] = df_excel['Filename'].apply(lambda x: 'July 2020' if x[0:2] == '07'
                                                         ...
                                                         else 'August 2020' if x[0:2] == '08'
                                                         else 'September 2020' if x[0:2] == '09'
                                                         else 'October 2020' if x[0:2] == '10'
                                                         else 'November 2020' if x[0:2] == '11'
                                                         else 'December 2020' if x[0:2] == '12' else 'other')
    df_excel['RunDate'] = df_excel['Filename'].apply(lambda x: '07/15/2020' if x[0:2] == '07'
                                                     ...
                                                     else '08/15/2020' if x[0:2] == '08'
                                                     else '09/15/2020' if x[0:2] == '09'
                                                     else '10/15/2020' if x[0:2] == '10'
                                                     else '11/15/2020' if x[0:2] == '11'
                                                     else '12/15/2020' if x[0:2] == '12' else 'other')
...
# list of star measure, object to change each year
